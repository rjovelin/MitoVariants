# -*- coding: utf-8 -*-
"""
Created on Mon Jun 20 16:14:44 2016

@author: RJovelin
"""

# use this script to plot the proportions of tumor RNA variants with > 2 alleles in tRNAs

# usage python3 PlotMultiAllelestRNAs.py [options]
